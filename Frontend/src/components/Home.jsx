...
import { FaBrain, FaSearchDollar, FaComments, FaLightbulb, FaChartLine, FaLaptopCode, FaRocket, FaUsers, FaEnvelope } from 'react-icons/fa'; // Example icons
...
function Home({ token }) {
  ...
  const styles = {
    ...
    aboutImage: {
      ...
      height: 'auto',
      display: 'block',
      borderRadius: '12px', // If image doesn't fill container perfectly
